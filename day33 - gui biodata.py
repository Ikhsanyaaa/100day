...
inf = Radiobutton(window, text ="informatika", value = "informatika").place(x= 100, y = 80)
pwk = Radiobutton(window, text ="pwk", value = "pwk").place(x= 200, y = 80)
sipil = Radiobutton(window, text ="teknik sipil", value = "teknik sipil").place(x= 300, y = 80)
