...
tanggal penyetoran : {tanggal}-{bulan}-{tahun}
waktu pennyetoran : {jam}:{menit}'''
                struk.write(teks)
                struk.close()
...
saldo saat ini : {akun[3]}
tanggal penarikan : {tanggal}-{bulan}-{tahun}
waktu penarikan : {jam}:{menit}'''
                struk.write(teks)
                struk.close()
                print("struk berhasil dicetak")
                menu()
...
tanggal pengiriman : {tanggal}-{bulan}-{tahun}
waktu pengiriman : {jam}:{menit}'''
                        struk.write(teks)
                        struk.close()
                        print("struk berhasil dicetak")
                        menu()
